  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Gaming inventory specific colors
        "bw-main-bg": "hsl(var(--bw-main-bg))",
      ...
      spacing: {
        "15": "60px", // TopMenu height
        "50": "200px", // Chat height
        "75": "300px", // Old equipment panel width
        "112": "450px", // Equipment panel width (1.5x wider)
        "123": "495px", // Equipment panel width (10% wider than 450px)
      },
      borderRadius: {
        lg: "var(--radius)",
