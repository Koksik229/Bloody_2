      ...
      <div className="w-full space-y-3 flex flex-col h-full">
        ...
        <div className="bg-bw-card-bg border border-bw-border rounded-2xl p-4 shadow-lg flex flex-col flex-1 min-h-0">
          ...
          <ScrollArea className="flex-1 bw-scrollbar h-0">
            <div className="space-y-2 pr-2 max-w-2xl">
              {filteredItems.map((item) => (
                <div
                  key={item.id}
                  className="bg-gradient-to-r from-bw-muted to-bw-card-bg border border-bw-border rounded-lg p-3 hover:border-bw-accent-gold/60 hover:shadow-lg transition-all duration-300 max-w-xl"
                >
